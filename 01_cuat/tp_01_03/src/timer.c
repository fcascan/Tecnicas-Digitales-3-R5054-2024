...
__attribute__((section(".text_timer_init")))void __timer_init() {
   _timer_t* const TIMER0 = (_timer_t*) TIMER0_ADDR;

   TIMER0->Timer1Load = 0x0010000; // Configuro registro que va a ser decrementado periodicamente
   TIMER0->Timer1Ctrl = 0x0000002; // Timer 32 bits
   TIMER0->Timer1Ctrl |=0x0000040; // Timer periodico
   TIMER0->Timer1Ctrl |=0x0000020; // Interrupccion timer habilitada
   TIMER0->Timer1Ctrl |=0x0000080; // Habilitacion TIMER
}
